    ...
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create()
        {
           ...
           ViewBag.CourseId = new SelectList(db.Courses, "CourseId", "Code");
            ViewBag.GradeId = new SelectList(db.GradeLetters, "GradeId", "GradeLetter");
            return View();
        }
        ...
        {
              Create();
            PopulateDropdownList(aCourse);

            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "RegNo");
            ViewBag.GradeId = new SelectList(db.GradeLetters, "GradeId", "gradeLetterId");
            ...
            enrollment.GradeLetterId = aCourse.CourseId;
        ...
        public ActionResult SelectCourseForStudent(int? studentId)
        {
         ...
         //   List<Course> queryable = db.Courses.Where(c => c.DepartmentId == student.DepartmentId).ToList();
            var courses = db.Courses.Where(c => c.CourseId == student.DepartmentId);
        ...
        public ActionResult StudentResultEntry()
        {
            ViewBag.StudentId = new SelectList(db.Students, "StudentId", "RegNo");
            ViewBag.CourseId = new SelectList(db.Courses, "CourseId", "Code");
           ViewBag.Courses = new SelectList(db.Courses);
        ...
        public ActionResult StudentResultEntry(Enrollment enrollment)
        {
            ...
            //  GradeLetter grade = db.GradeLetters.Where(g => g.GradeLetterId == enrollment.GradeLetterId).Single();
